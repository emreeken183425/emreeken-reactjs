  ...
  return (
    <>
      <div className="flex m-2 text-center  justify-evenly mb-5 mt-4 p-2 ">
        <button
          className="btn btn-outline-line bg-warning "
          onClick={() => {
            filteredResult("Clothing");
          }}
        >
          {" "}
          Clothing{" "}
